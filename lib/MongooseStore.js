(function () {
    ...
    function MongooseStore (options) {
        ...
        if (typeof options.connection === "string") mongoose = require('mongoose').createConnection(options.connection);
        else mongoose = options.connection;
        ...
        var Model = mongoose.model(options.modelName || MongooseStore.defaultOptions.modelName, Session);
    ...
    module.exports = function (Store) {
        ...
        return function (options) {
            options = options || {
                connection: MongooseStore.defaultOptions.connection
            };
            options.superclass = options.superclass || Store;
